    ...
    pub fn snapshot(&self) -> TrackerTelemetrySnapshot {
        TrackerTelemetrySnapshot {
            ...
            consensus_recovered_blocks: self
                ...
                .load(Ordering::Relaxed),
            consensus_reorgs_detected: self.inner.consensus_reorgs_detected.load(Ordering::Relaxed),
...
pub struct TrackerTelemetrySnapshot {
    ...
    pub consensus_reorgs_detected: u64,
...
pub(crate) struct RuntimeTelemetry {
    ...
    consensus_reorgs_detected: AtomicU64,
...
impl RuntimeTelemetry {
    pub(crate) fn new(transport_kind: TransportKind) -> Self {
        Self {
            ...
            consensus_reorgs_detected: AtomicU64::default(),
    ...
    #[allow(dead_code)]
    pub(crate) fn record_consensus_reorg_detected(&self) {
        self.consensus_reorgs_detected
